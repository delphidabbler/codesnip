...
type
  TMainForm = class(TRootForm)
    ...
    actCloseSelectedDetailsTab: TAction;
    actFAQs: TBrowseURL;
    ...
    ///  <summary>Closes currently selected tab in details pane.</summary>
    procedure actCloseSelectedDetailsTabExecute(Sender: TObject);
    ...
    ///  <summary>Determines whether ExportCode action can be enabled.</summary>
    ...
    ///  <summary>Determines whether any actions that close tabs in details pane
    ...
    ///  <summary>Determines whether actions that require a non-empty user
    ///  database can be enabled.</summary>
...
procedure TMainForm.actCloseSelectedDetailsTabExecute(Sender: TObject);
begin
...
begin
  try
    ...
    begin
      ...
      AddSpacer(cDetailPopupMenuIDs);
      AddAction(actCloseSelectedDetailsTab, cDetailPopupMenuIDs);
      // tab set menu
      AddAction(actCloseSelectedDetailsTab, cDetailTabSetPopupMenu);
...
procedure TMainForm.splitVertCanResize(Sender: TObject; var NewSize: Integer;
  var Accept: Boolean);
begin
