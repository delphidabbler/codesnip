...
uses
  ...
  DB.Categories in 'DB.Categories.pas',
  DB.IO.Manager in 'DB.IO.Manager.pas',
  DB.Main in 'DB.Main.pas',
  DB.Snippets in 'DB.Snippets.pas',
  DB.SnippetKind in 'DB.SnippetKind.pas',
  DB.IO.Vault in 'DB.IO.Vault.pas',
  DB.IO.Vault.DCSCv2 in 'DB.IO.Vault.DCSCv2.pas',
  DB.IO.Vault.Null in 'DB.IO.Vault.Null.pas',
  DB.IO.Vault.CS4 in 'DB.IO.Vault.CS4.pas',
  ...
  DB.IO.ImportExport.CS4 in 'DB.IO.ImportExport.CS4.pas',
  ...
  DB.IO.Categories in 'DB.IO.Categories.pas',
