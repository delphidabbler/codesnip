inherited MainForm: TMainForm
        ...
        inherited frmDetailView: TDetailViewFrame
          ...
          inherited pnlBrowser: TPanel
            ...
            inherited wbBrowser: TWebBrowser
              ...
              ExplicitHeight = 647
              ControlData = {
                4C000000023D0000542600000000000000000000000000000000000000000000
  ...
  object ActionList: TActionList
    ...
    object actCloseSelectedDetailsTab: TAction
      Category = 'View'
      Caption = 'Close Tab'
      ...
      SecondaryShortCuts.Strings = (
        'Ctrl+W')
      ShortCut = 16499
      OnExecute = actCloseSelectedDetailsTabExecute
        ...
        Items = <
          ...
          item
            Items = <
              ...
              item
                Action = actCloseSelectedDetailsTab
                Caption = 'Cl&ose Tab'
                ImageIndex = 38
                ShortCut = 16499
              end
