{
 * FmCompilersDlg.UBannerMgr.pas
 *
 * Implements a class that manages display of compiler name and glyph in a paint
 * box. This is a helper class for TCompilersDlg.
 *
 * $Rev$
 * $Date$
 *
 ...
 *
 * The Original Code is FmCompilersDlg.UBannerMgr.pas
 *
